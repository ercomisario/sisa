@extends('layouts.app')
@section('title','Cuidados Médicos')
@section('content')
@isset($person)
...
@endisset
    <main class="container-fluid padding-lateral-0">
				<div class="bg-white shadow">
					<div class="row no-gutters">
						...
						<div class="col-lg-3  d-none d-sm-inline-block text-center identifier-view-2" style="">
							<span class="text-identifier-view"><strong>Cuidados</strong></span>
						</div>
						...
						<div class="container mt-5">
						  <div class="row">
						    <div class="col-sm-4 col-xl-4 col-lg-4">                                                          
										<h1 class="h3 mb-3 text-s ml-5 mb-4"><strong>Cuidados por Aplicar</strong></h1>
			                		...
			                		<div class="row">
			                				...
			                				<div class="col-8">
			                					<span class="text-p" style="" id="CardPacieteName"></span><br>
																...
																<input type="hidden" id="CardPacieteHealthCare" value="">
	    	                ...
	    	                <div class="card shadow card-border card-mb-10">
						          		<div class="tab tabs-registry-clinical-secondary" id="">
						          		  <ul class="nav nav-tabs" role="tablist">
						          		      <li class="nav-item nav-item-tabs-s" style="padding: 5px"><a class="nav-link active" href="#tab-desc-cuidado" data-toggle="tab" role="tab" aria-selected="true"><strong>Descripción del Cuidado</strong></a></li>
						          			  <li class="nav-item nav-item-tabs-s" s style="padding: 5px"><a class="nav-link " href="#tab-historico-cuidado" data-toggle="tab" role="tab" aria-selected="false"><strong>Historicos de Cuidados</strong></a></li>
						          		  </ul>
						          		  <div class="tab-content" style="min-height: 300px; border-radius:0px; box-shadow: 0 .1rem .2rem rgba(0,0,0,.00);">
						          		      <div class="tab-pane active" id="tab-desc-cuidado" role="tabpanel">
						          		      		<div class="row m-4" id="CardPacieteCuidadoDescID">
			          		      							
			          		      					</div>
			          		      					<form method="POST" action="javascript:guardarHealthCare()">
																			@csrf
		    		      		       		      <div class="form-row mt-3">
		      		      		       		      	<div class="form-group  col-md-12 col-lg-12 mt-3">
		      		      		       		      		<div class="form-inline justify-content-center "> 
		      		      		       		      			<label class="custom-control  custom-radio mr-4">
		      		      		       		              <input name="aplicadoCuidado" type="radio" class="custom-control-input" id="obs_enf" value="1" checked="true">
		      		      		       		              <span class="custom-control-label">Aplicado</span>
		      		      		       		            </label>
		      		      		       		      			<label class="custom-control  custom-radio mr-4">
		      		      		       		              <input name="aplicadoCuidado" type="radio" class="custom-control-input" id="obs_enf_no" value="0">
						          		      ...
						          		      <div class="tab-pane" id="tab-historico-cuidado" role="tabpanel">
						          		      	<div class="list-date-health-care">
						          		      			<div class="container-fluid" id="CardPacieteCuidadoHistorico">
				...
				<script src="{{ asset('js/healthcare.js') }}" ></script>
				<script type="text/javascript">
					let asset_global='{{asset("/")}}';
					$(document).ready(function () {
							let route='GetListadoPacienteCuidado';

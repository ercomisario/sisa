@extends('layouts.app')
@section('title','Reporte de Enfermería')
@section('content')
    @isset($person)
...
@endisset
				...
				<div class="bg-white shadow">
					<div class="row no-gutters">
						...
						<div class="col-lg-3  d-none d-sm-inline-block text-center identifier-view-2" style="">
							<span class="text-identifier-view"><strong>Reporte de Enfernería</strong></span>
						</div>
	    	                ...
	    	                <div class="card shadow card-border card-mb-10">
						          		<div class="tab tabs-registry-clinical-secondary" id="">
						          		  <ul class="nav nav-tabs" role="tablist">
						          		      <li class="nav-item nav-item-tabs-s" style="padding: 5px"><a class="nav-link active" href="#tab-desc-cuidado" data-toggle="tab" role="tab" aria-selected="true"><strong>Reportes de Jornadas</strong></a></li>
						          			  <li class="nav-item nav-item-tabs-s" s style="padding: 5px"><a class="nav-link " href="#tab-historico-cuidado" data-toggle="tab" role="tab" aria-selected="false"><strong>Historicos de Jornadas</strong></a></li>
						          		  </ul>
						          		  <div class="tab-content" style="min-height: 300px; border-radius:0px; box-shadow: 0 .1rem .2rem rgba(0,0,0,.00);">
						          		      	...
						          		      	<div class="row">
						          		      		<div class="col-12 mt-5">
						          		      			 <div class="media d-block d-md-flex mt-2">
																	   		  <div class="shadow card text-center text-p" id="CardEnfermeraInfo" style="border-radius: 1rem">
																	   		  	
																	   		  </div>
																		   		  <div class="media-body text-center text-md-left ml-md-3 ml-0">
																		   		  	<form method="POST" action="javascript:gudarRepEnfermeria()">
			    																			@csrf
																	   		      	<div class="form-row mt-3">
																		   		      	  <div class="form-group col-md-12 col-lg-12">
																											<textarea class="form-control" rows="3" id="descripcion" placeholder="Reporte..." required></textarea>
																										</div>
						          		      ...
						          		      <div class="tab-pane" id="tab-historico-cuidado" role="tabpanel">
						          		      	<div class="list-date-health-care">
						          		      			<div class="container-fluid" id="CardPacieteReporteHistorico">
				...
				<script src="{{ asset('js/evolution.js') }}" ></script>
				<script type="text/javascript">
						...
						$(document).ready(function () {
								...
								let route='GetListadoPacienteReporte';

...
! function(t, s, e, n) {
    ...
    t.extend(i.prototype, {
        ...
        _setToolbar: function() {
            ...
            var s = this.options.toolbarSettings.showNextButton !== !1 ? t("<button></button>").text(this.options.lang.next).addClass("btn btn-warning sw-btn-next").attr("type", "button") : null,
                e = this.options.toolbarSettings.showPreviousButton !== !1 ? t("<button></button>").text(this.options.lang.previous).addClass("btn btn-warning sw-btn-prev").attr("type", "button") : null,
